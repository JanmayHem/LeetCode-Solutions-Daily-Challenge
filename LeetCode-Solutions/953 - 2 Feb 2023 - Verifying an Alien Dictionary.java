/*
	...
	Memory Usage: 40.9 MB, less than 77.38% of Java online submissions.
*/
...
class Solution {
    ...
    private boolean isSorted(String word1, String word2, int[] orderMap) {
        ...
        for (int i = 0; i < len; i++) {
            if (word1.charAt(i) != word2.charAt(i)) return orderMap[word1.charAt(i) - 'a'] < orderMap[word2.charAt(i) - 'a'];
        }
